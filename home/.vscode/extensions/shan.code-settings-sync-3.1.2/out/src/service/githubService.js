...
class GitHubService {
    constructor(userToken, basePath) {
        ...
        if (userToken !== null && userToken !== "") {
            githubApiConfig.auth = userToken;
        }
        this.github = new Octokit(githubApiConfig);
        this.github.rest.users
            .getAuthenticated()
            .then(res => {
    ...
    CreateEmptyGIST(publicGist, gistDescription) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const res = yield this.github.rest.gists.create(this.GIST_JSON_EMPTY);
    ...
    ReadGist(GIST) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.github.rest.gists.get({ gist_id: GIST });
        });
    }
    ...
    SaveGIST(gistObject) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.github.rest.gists.update(gistObject);
            return true;
        });
    }
}
